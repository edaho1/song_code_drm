...
int main(){
    ...
    static uint8_t mpriv_key[ECC_PRV_KEY_SIZE] = {
        0x55,0xff,0x72,0x56,0x3e,0x87,0x3c,0xc3,
        0xbe,0x29,0x7e,0xd3,0x32,0x52,0x87,0x74,
        0x37,0xa9,0x9f,0x81,0xb8,0x7d,0x09,0x54
    };
...
/*    struct user *master;// = {mpriv_key, pub_key}; //handling master key for encryption 
    ...
    encrypt_song (nist_key,raw_song, enc_song);
